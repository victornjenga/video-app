...
function VideoCard({
  ...
  return (
    <div className="flex flex-col justify-center items-center border-b-2 border-gray-200 pb-6">
      <div>
        <div className="flex gap-3 justify-start p-2 cursor-pointer font-semibold rounded ">
      ...
      <div className="lg:ml-20 flex gap-4 relative justify-center items-center">
        ...
        >
          ...
          {isHover && (
            <div className="absolute bottom-6 cursor-pointer left-8 md:left-10 lg:left-0 flex gap-10 lg:justify-between w-[100px] md:w-[50px] lg:w-[600px] p-3">
              {playing ? (
